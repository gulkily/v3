...
generate a signed, single-use invitation. New links use a 128-bit, 32-character
hexadecimal bearer secret in the browser fragment; share it only with the intended recipient.
