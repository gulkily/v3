...
- 2026-06-19: Slice D reviewed. No template or smoke-test changes were needed: production Account-page copy no longer emits the old manual-submit success message, the simple status mapping already turns the linked success status into `All set! Posting as {username}.`, and the advanced manual form remains available.
