...
- **Profiles & permalinks.** No profile pages, no user directory. ✅ Single-post permalink done (see `forte_post_permalink_step4_implementation_summary.md`) — every post/reply on the board now has a shareable "#" link. Profiles/user directory still open.
