...
{
    public function testCompletedRunReportsSlowestTests(): void
    {
        ...
        assertStringContains('Slowest tests:', $stdout);
    ...
    public function testInterruptedRunReportsCurrentSlowTest(): void
    {
        ...
        $process = proc_open(
            ...
            $pipes,
            dirname(__DIR__),
            ['FORUM_TEST_RUNNER_SIGNAL_FIXTURE' => '1'] + $_ENV
        );
        ...
        assertStringContains('Slowest tests so far:', $combinedOutput);
